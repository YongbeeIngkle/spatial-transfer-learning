...
usa_whole_tags = ['day', 'month', 'cmaq_x', 'cmaq_y', "cmaq_id", 'rid', 'elev', 'forest_cover', 'pd', 'local', 'limi', 'high', 'is',
...
transfer_tags = {
    ...
    "california": {
        "source": usa_input_tags,
        "target": usa_input_tags
    }
    }
